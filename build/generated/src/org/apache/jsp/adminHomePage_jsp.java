...
public final class adminHomePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-12\" align=\"left\" style=\"width:200px; height:500px;background-color:#99CC99\"> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t <label style=\"color:#000000\">Messages</label></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t <label style=\"color:#000000\">Requests</label></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 \" style=\"width:800px;height:15px;\" ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 rcorners\" style=\"width:150px;height:120px;padding-top:10px;\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\"><span class=\"glyphicon glyphicon-wrench\" style=\"font-size:60px; color:#99CCCC;\"></span><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t <label style=\"color:#000000\">Vendor Handling</label></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 \" style=\"width:15px;height:120px;\" ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 rcorners\" style=\"width:150px;height:120px;padding-top:10px;\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\"><span class=\"glyphicon glyphicon-ok-sign\" style=\"font-size:60px; color:#CCCC00;\"></span><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t <label style=\"color:#000000\">Vendor Attendance</label></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 \" style=\"width:15px;height:120px;\" ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 rcorners\" style=\"width:150px;height:120px;padding-top:10px;\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\"><span class=\"glyphicon glyphicon-search\" style=\"font-size:60px; color:#666666;\"></span><br/>\r\n");
