        	...
        	<div class="row">
            	<div class="col-lg-6">
               	  <div id="left_side">
                        	...
                        	<h2>&nbsp;&nbsp;&nbsp;Welcome to Thursday Good Market</h2>
                            	<p>&nbsp;<b><em>Location</em></b>:<strong> waters Edge</strong></p>
                                <p>&nbsp;<b><em>Venue</em></b>: Thursday from <b><em>10 AM to 6 PM</em></b>(rain or shine)</p>
                            <h3>&nbsp;&nbsp;Vendors on Thursday Good Market</h3>
                            <div id="d1">
        						<ul>
                            ...
                            <div id="other_set">
             					<h3>&nbsp;&nbsp;Other vendors on Thursday Market</h3>
              						<ul>
