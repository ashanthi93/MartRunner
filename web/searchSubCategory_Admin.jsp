                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9" style="padding-top: 10px;">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color:#71C671; ">
                                <div class="panel-title" style="color:#000; font-weight:bold; font-size: 20px;"> Search by Sub Category </div>
                            </div>
                            <br/>
                                        ...
                                        <form action="" method="get" class="form-horizontal">
                                            <div class="form-group col-xs-10">
                                                <ul style="list-style:none;">
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Organic Products </li>
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Animal based Farm Products </li>
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Prepared Foods </li>
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Natural Body & Home </li>
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Art & Handicrafts </li>
                                                    <li> <input type="radio" name="hiddenVendorName"  /> Travel </li>
                                                    <li> <input type="radio" name="hiddenVendorName" /> General </li>
                                                </ul>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="panel-body">
                                        <form action="" method="get" class="form-horizontal">
                                            <div class="form-group col-xs-10">
                                                <ul style="list-style:none;">
                                                    <li> <input type="radio" name="hiddenVendorName" value="Hidden" disabled="disabled" /> Rural Producers </li>
                                                    <li> <input type="radio" name="hiddenVendorName" value="Hidden" disabled="disabled"/> Social Enterprise </li>
                                                    <li> <input type="radio" name="hiddenVendorName" value="Hidden" disabled="disabled" /> Responsible Business </li>
                                                </ul>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
