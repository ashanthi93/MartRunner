                                                ...
                                                <!--half stall  radio-->
                                                 <div class="row">
                                                    <div class="radio col-xs-5 col-xs-offset-3 col-sm-offset-4 col-lg-6">
                                                        ...
                                                        <label>
                                                            <input type="radio" name="stalltype" id="type1" value="t1"> One Day &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        </label> 
                                                        <br>
                                                        <label>
                                                            <input type="radio" name="stalltype" id="type2" value="t2"> One Month &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        </label>
                                                        <br>
                                       ...
                                       <label for="fullstall" class="col-xs-10  col-xs-offset-2 col-sm-10 col-md-offset-3 col-md-10 col-lg-10 control-label" style="text-align:left; font-weight: normal;">Full Stall Payments</label>
                                             <!--Full stall  radio-->
                                                    ...
                                                    <div class="radio col-xs-10 col-xs-offset-3 col-sm-offset-4 col-lg-6">
                                                        ...
                                                        <br>
                                                        <label>
                                                            <input type="radio" name="stalltype" id="type1" value="t1"> Quarter 
                                                        </label> 
                                                    </div>  
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="radio col-xs-5 col-xs-offset-3 col-sm-offset-4 col-lg-6">
                                                        ...
                                                        <label>
                                                            <input type="radio" name="stalltype" id="type1" value="t1"> Saturday &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        </label> 
                                                        <br>
                                                        <label>
                                                            <input type="radio" name="stalltype" id="type2" value="t2"> Thursday &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                                        </label>
                           ...
                           <div class="panel-body">
                                ...
                                <!--ok,cancel Buttons-->
                                        <div class="row">
                                            ...
                                            <center>
                                                <div class="col-xs-2 col-xs-offset-3 col-sm-offset-5 col-sm-2 col-md-2 col-lg-2 ">
                                                    <button type="button" id="viewpaymentok" class="btn btn-default " value="Hidden" disabled="disabled" style="width:auto; color:black;border-color: green;" > <strong>Remove</strong></button>
                                                </div>
