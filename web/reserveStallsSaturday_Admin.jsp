...
<html>
    <head>
        ...
        <title> Reserve Stalls Saturday | Admin </title>
                            ...
                            <div class="panel-body">
                                <center>
                                    ...
                                    <div style="width:auto; height:auto; background-color:#71C671; margin-top:10px;"> 
                                        ...
                                        <br/><br/>
                                        <a class="btn btn-default active" style="width:auto" href="reserveStallsSaturday_Admin.jsp">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default" style="margin-top: 10px;">
                                <div class="panel-heading" style="background-color:#71C671;">
                                    <div class="panel-title" style="color:#000; font-weight:bold; font-size: 20px;"> Reserve Saturday Stalls</div>
                                </div>
                            </div>
